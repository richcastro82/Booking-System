...
class Controller extends \BookneticApp\Providers\Core\Controller
{
	public function index()
	{
        ...
        if ( Capabilities::userCan( 'settings_general' ) )
        {
        ...
        if ( Capabilities::userCan( 'settings_booking_panel_steps' ) )
        {
            SettingsMenuUI::get( 'frontend' )
        ...
        if ( Capabilities::userCan( 'settings_booking_panel_labels' ) )
        {
            SettingsMenuUI::get( 'frontend' )
        ...
        if ( Capabilities::userCan( 'settings_payments' ) )
        {
            SettingsMenuUI::get( 'payment_settings' )
        ...
        if ( Capabilities::userCan( 'settings_payment_gateways' ) )
        {
            SettingsMenuUI::get( 'payment_settings' )
        ...
        if ( Capabilities::userCan( 'settings_company' ) )
        {
        ...
        if ( Capabilities::userCan( 'settings_business_hours' ) )
        {
        ...
        if ( Capabilities::userCan( 'settings_holidays' ) )
        {
